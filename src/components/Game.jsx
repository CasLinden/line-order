...
function Game() {
  ...
  // const yamanoteStationsRomaji = ['Tokyo', 'Kanda', 'Akihabara', 'Okachimachi', 'Ueno', 'Uguisudani', 'Nippori', 'Nishi-Nippori', 'Tabata', 'Komagome', 'Sugamo', 'Ōtsuka', 'Ikebukuro', 'Mejiro', 'Takadanobaba', 'Shin-Ōkubo', 'Shinjuku', 'Yoyogi', 'Harajuku', 'Shibuya', 'Ebisu', 'Meguro', 'Gotanda', 'Ōsaki', 'Shinagawa', 'Takanawa Gateway', 'Tamachi', 'Hamamatsuchō', 'Shimbashi', 'Yūrakuchō']
  ...
  // const yamanoteStationsHiragana = ['とうきょう', 'かんだ', 'あきはばら', 'おかちまち', 'うえの', 'うぎすだに', 'にっぽり', 'にしにっぽり', 'たばた', 'こまごめ', 'すがも', 'おつか', 'いけぶくろ', 'めじろ', 'たかだのばば', 'しんおおくぼ', 'しんじゅく', 'よよぎ', 'はらじゅく', 'しぶや', 'えびす', 'めぐろ', 'ごたんだ', 'おおさき', 'しながわ', 'たかなわゲートウェイ', 'たまち', 'はままつちょ', 'しんばし', 'ゆうらちょ']
